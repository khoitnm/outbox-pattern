...
public class SampleOutboxRest {
  ...
  public void unique_allSuccess(@PathVariable("outboxId") String outboxId) {
    sampleOutboxPublisher.unique_allSuccess(outboxId);
  }

  @GetMapping("/outbox/unique/{outboxId}/publish/error")
  public void unique_publishError(@PathVariable("outboxId") String outboxId) {
    sampleOutboxPublisher.unique_publishError(outboxId);
  }

  @GetMapping("/outbox/unique/{outboxId}/consume/error")
  public void unique_consumeError(@PathVariable("outboxId") String outboxId) {
    sampleOutboxPublisher.unique_consumeError(outboxId);
  }
